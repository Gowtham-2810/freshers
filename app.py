...
def is_valid_email_format(email):
    ...
    # Additional validation to check for common domain names (like 'gmail.com') if needed
    # For example, this can ensure a domain part with at least one dot
...
def register():
    ...
    if not is_valid_email_format(attendee_info['email']):
